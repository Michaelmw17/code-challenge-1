...
var PrerenderManifest__default =
  /*#__PURE__*/ _interopDefaultLegacy(PrerenderManifest);
var Manifest__default = /*#__PURE__*/ _interopDefaultLegacy(Manifest);
var RoutesManifestJson__default =
  /*#__PURE__*/ _interopDefaultLegacy(RoutesManifestJson);
...
const handler = (event, { enableHTTPCompression } = defaultOptions) => {
  ...
  const req = Object.assign(
    newStream,
    http__default["default"].IncomingMessage.prototype
  );
...
var supportsKeyObjects =
  typeof crypto__default["default"].createPublicKey === "function";
...
function createHmacVerifier(bits) {
  return function verify(thing, signature, secret) {
    ...
    return bufferEqualConstantTime(
      Buffer$4.from(signature),
      Buffer$4.from(computedSig)
    );
  };
}
      ...
      signer.sign(
        {
          ...
          saltLength:
            crypto__default["default"].constants.RSA_PSS_SALTLEN_DIGEST,
        },
        "base64"
      ));
    return fromBase64(sig);
...
function jwsSecuredInput(header, payload, encoding) {
  ...
  return util__default["default"].format(
    "%s.%s",
    encodedHeader,
    encodedPayload
  );
...
function headerFromJWS(jwsSig) {
  ...
  return safeJsonParse(
    Buffer$7.from(encodedHeader, "base64").toString("binary")
  );
}
...
var verify$1 = function (jwtString, secretOrPublicKey, options, callback) {
  ...
  return getSecret(header, function (err, secretOrPublicKey) {
    ...
    if (hasSignature && !secretOrPublicKey) {
      return done(
        new JsonWebTokenError_1("secret or public key must be provided")
      );
    }
    ...
    if (typeof payload.nbf !== "undefined" && !options.ignoreNotBefore) {
      ...
      if (payload.nbf > clockTimestamp + (options.clockTolerance || 0)) {
        return done(
          new NotBeforeError_1("jwt not active", new Date(payload.nbf * 1000))
        );
      }
    }
    ...
    if (typeof payload.exp !== "undefined" && !options.ignoreExpiration) {
      ...
      if (clockTimestamp >= payload.exp + (options.clockTolerance || 0)) {
        return done(
          new TokenExpiredError_1("jwt expired", new Date(payload.exp * 1000))
        );
      }
    }
    ...
    if (options.maxAge) {
      if (typeof payload.iat !== "number") {
        return done(
          new JsonWebTokenError_1("iat required when maxAge is specified")
        );
      }
...
function isPlainObject(value) {
  if (
    ...
    objectToString$4.call(value) != objectTag ||
    isHostObject(value)
  ) {
    return false;
  }
...
function isString$1(value) {
  return (
    ...
    (!isArray$1(value) &&
      ...
      objectToString$5.call(value) == stringTag$1)
  );
}
...
var sign_options_schema = {
  ...
  header: {
    isValid: lodash_isplainobject,
    message: '"header" must be an object',
  },
  encoding: {
    isValid: lodash_isstring,
...
const buildS3RetryStrategy = async () => {
  const { defaultRetryDecider, StandardRetryStrategy } =
...
const handleOriginResponse = async ({ event, manifest, prerenderManifest }) => {
  ...
  const s3 = new S3Client({
    region:
      (_b =
        (_a = request.origin) === null || _a === void 0 ? void 0 : _a.s3) ===
        null || _b === void 0
        ? void 0
        : _b.region,
    maxAttempts: 3,
  ...
  if (
    ...
    const { req, res, responsePromise } = nextAwsCloudfront(
      event.Records[0].cf,
      {
        enableHTTPCompression: manifest.enableHTTPCompression,
      }
...
function cloneQuery(query) {
  return Object.keys(query).reduce(function (carry, paramName) {
    ...
    return __assign(
      __assign({}, carry),
      ((_a = {}),
      (_a[paramName] = Array.isArray(param) ? __spread(param) : param),
      _a)
    );
  }, {});
}
...
var isThrottlingError = function (error) {
  ...
  return (
    ...
    ((_a = error.$retryable) === null || _a === void 0
      ? void 0
      : _a.throttling) == true
  );
};
...
var defaultDelayDecider = function (delayBase, attempts) {
  return Math.floor(
    Math.min(
      MAXIMUM_RETRY_DELAY,
      Math.random() * Math.pow(2, attempts) * delayBase
    )
  );
};
...
var StandardRetryStrategy = /** @class */ (function () {
  ...
  StandardRetryStrategy.prototype.shouldRetry = function (
    error,
    attempts,
    maxAttempts
  ) {
              ...
              return __generator(this, function (_b) {
                switch (_b.label) {
                  ...
                  case 1:
                    ...
                    return [
                      2 /*return*/,
                      { value: { response: response, output: output } },
                    ];
                  case 2:
                    err_1 = _b.sent();
                    attempts++;
                    if (!this_1.shouldRetry(err_1, attempts, maxAttempts))
                      return [3 /*break*/, 4];
                    retryTokenAmount =
                      this_1.retryQuota.retrieveRetryTokens(err_1);
...
var resolveRetryConfig = function (input) {
  ...
  return __assign(__assign({}, input), {
    ...
    retryStrategy:
      input.retryStrategy || new StandardRetryStrategy(maxAttempts),
  });
};
...
var homepage =
  "https://github.com/aws/aws-sdk-js-v3/tree/master/clients/client-s3";
var repository = {
  type: "git",
  ...
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 2:
          hostname = ((_b = _c.sent()) !== null && _b !== void 0 ? _b : {})
            .hostname;
          if (!hostname) {
...
function chain() {
  ...
  return function () {
    ...
    try {
      for (
        var providers_1 = __values(providers),
...
function requestFromEcsImds(timeout, options) {
  ...
  return httpRequest(
    __assign(__assign({}, options), { timeout: timeout })
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              2 /*return*/,
              getCredentials(maxRetries, { timeout: timeout }),
            ];
          case 1:
            token = void 0;
            _a.label = 2;
    ...
    configFilepath =
      _b === void 0
        ? process.env[ENV_CONFIG_PATH] ||
          path.join(getHomeDir(), ".aws", "config")
        : _b;
  return Promise.all([
...
function normalizeConfigFile(data) {
  ...
  try {
    for (
      var _b = __values(Object.keys(data)), _c = _b.next();
      !_c.done;
      _c = _b.next()
    ) {
      var key = _c.value;
...
function parseIni(iniData) {
  ...
  try {
    for (
      var _b = __values(iniData.split(/\r?\n/)), _c = _b.next();
      !_c.done;
      _c = _b.next()
    ) {
      var line = _c.value;
      ...
      switch (_f.label) {
        case 0:
          ...
          sourceCreds = resolveProfileData(
            ...
            options,
            __assign(
              __assign({}, visitedProfiles),
              ((_e = {}), (_e[source_profile] = true), _e)
            )
          );
          params = {
            RoleArn: RoleArn,
      ...
      switch (_a.label) {
              ...
              .then(function (processResult) {
                ...
                if (
                  ...
                  throw Error(
                    "Profile " +
                      profileName +
                      " credential_process returned invalid credentials."
                  );
                }
                var expirationUnix;
                if (expiration) {
        ...
        case 4:
          ...
          throw new ProviderError(
            "Profile " +
              profileName +
              " could not be found in shared credentials file."
          );
        case 5:
          return [2 /*return*/];
      }
...
function __asyncDelegator(o) {
  ...
  function verb(n, f) {
    i[n] = o[n]
      ? function (v) {
          return (p = !p)
            ? { value: __await$1(o[n](v)), done: n === "return" }
            : f
            ? f(v)
            : v;
        }
...
var HeaderMarshaller = /** @class */ (function () {
  ...
  HeaderMarshaller.prototype.format = function (headers) {
    ...
    try {
      for (
        var _c = __values(Object.keys(headers)), _d = _c.next();
        !_d.done;
        _d = _c.next()
      ) {
...
function splitMessage(_a) {
  ...
  var checksummer = new build.Crc32().update(
...
var EventStreamMarshaller$1 = /** @class */ (function () {
  ...
  EventStreamMarshaller$1.prototype.deserialize = function (
    body,
    deserializer
  ) {
...
var EventStreamMarshaller$2 = /** @class */ (function () {
  ...
  EventStreamMarshaller$2.prototype.deserialize = function (
    body,
    deserializer
  ) {
  ...
  EventStreamMarshaller$2.prototype.serialize = function (input, serializer) {
    var serializedIterable = this.universalMarshaller.serialize(
      input,
      serializer
    );
...
var fromArrayBuffer = function (input, offset, length) {
  ...
  if (!isArrayBuffer(input)) {
    throw new TypeError(
      'The "input" argument must be ArrayBuffer. Received type ' +
        typeof input +
        " (" +
        input +
        ")"
...
var fromString = function (input, encoding) {
  ...
  return encoding
    ? buffer$1.Buffer.from(input, encoding)
    : buffer$1.Buffer.from(input);
};
        ...
        return __generator(this, function (_f) {
          switch (_f.label) {
            ...
            case 7:
              return [
                2 /*return*/,
                next(__assign(__assign({}, args), { request: request })),
              ];
          }
        });
      });
...
var NODE_USE_ARN_REGION_CONFIG_OPTIONS = {
  environmentVariableSelector: function (env) {
    if (
      !Object.prototype.hasOwnProperty.call(env, NODE_USE_ARN_REGION_ENV_NAME)
    )
      return undefined;
    ...
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        try {
          ...
          throw new ProviderError(
            e.message ||
              "Cannot load config from environment variables with getter: " +
                envVarSelector
          );
        }
        return [2 /*return*/];
        ...
        switch (_d.label) {
          case 0:
            (_a = init.loadedConfig),
              ...
              (profile =
                _b === void 0
                  ? process.env[ENV_PROFILE$1] || DEFAULT_PROFILE$1
                  : _b);
            return [4 /*yield*/, loadedConfig];
          case 1:
            (_c = _d.sent()),
              (configFile = _c.configFile),
              (credentialsFile = _c.credentialsFile);
            profileFromCredentials = credentialsFile[profile] || {};
            profileFromConfig = configFile[profile] || {};
            mergedProfile =
              preferredFile === "config"
                ? __assign(
                    __assign({}, profileFromCredentials),
                    profileFromConfig
                  )
                : __assign(
                    __assign({}, profileFromConfig),
                    profileFromCredentials
                  );
            try {
...
function buildQueryString(query) {
  ...
  try {
    for (
      var _b = __values(Object.keys(query).sort()), _c = _b.next();
      !_c.done;
      _c = _b.next()
    ) {
      var key = _c.value;
...
var getTransformedHeaders = function (headers) {
  ...
  try {
    for (
      var _b = __values(Object.keys(headers)), _c = _b.next();
      !_c.done;
      _c = _b.next()
    ) {
      var name = _c.value;
    ...
    if (socket.connecting) {
      ...
      var timeoutId_1 = setTimeout(function () {
        ...
        var timeoutError = new Error(
          "Socket timed out without establishing a connection within " +
            timeoutInMs +
            " ms"
        );
...
function setSocketTimeout(request, reject, timeoutInMs) {
  ...
  request.setTimeout(timeoutInMs, function () {
    ...
    this.abort();
    var timeoutError = new Error(
      "Connection timed out after " + timeoutInMs + " ms"
    );
    timeoutError.name = "TimeoutError";
    reject(timeoutError);
  });
...
function parseQueryString(querystring) {
  ...
  if (querystring) {
    try {
      for (
        var _b = __values(querystring.split("&")), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
        var pair = _c.value;
...
function defaultUserAgent(packageName, packageVersion) {
  var engine =
    process__default["default"].platform +
    "/" +
  ...
  return (
    "aws-sdk-nodejs-v3-" + packageName + "/" + packageVersion + " " + engine
  );
}
...
var getUseRegionalEndpointPlugin = function (config) {
  return {
    applyToStack: function (clientStack) {
      clientStack.add(
        useRegionalEndpointMiddleware(config),
...
function getSigningKey(
  ...
  return (signingKeyCache[cacheKey] = new Promise(function (resolve, reject) {
    ...
    try {
      for (
        var _b = __values([shortDate, region, service, KEY_TYPE_IDENTIFIER]),
          _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
...
function getCanonicalHeaders(_a, unsignableHeaders, signableHeaders) {
  ...
  try {
    for (
      var _c = __values(Object.keys(headers).sort()), _d = _c.next();
      !_d.done;
      _d = _c.next()
    ) {
      var headerName = _d.value;
...
function getCanonicalQuery(_a) {
  ...
  try {
    for (
      var _d = __values(Object.keys(query).sort()), _e = _d.next();
      !_e.done;
      _e = _d.next()
    ) {
      var key = _e.value;
    ...
    return __generator(this, function (_f) {
      switch (_f.label) {
        case 0:
          try {
            for (
              _b = __values(Object.keys(headers)), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              headerName = _c.value;
...
function moveHeadersToQuery(request) {
  ...
  try {
    for (
      var _d = __values(Object.keys(headers)), _e = _d.next();
      !_e.done;
      _e = _d.next()
    ) {
      var name = _e.value;
...
var SignatureV4 = /** @class */ (function () {
      ...
      return __generator(this, function (_l) {
        switch (_l.label) {
          ...
          case 4:
            ...
            canonicalHeaders = getCanonicalHeaders(
              request,
              unsignableHeaders,
              signableHeaders
            );
          ...
          case 5:
            return [
              ...
              _g.apply(
                this,
                _h.concat([_j.apply(this, _k.concat([_l.sent()]))])
              ),
            ];
          case 6:
            _e[_f] = _l.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_g) {
        switch (_g.label) {
          ...
          case 3:
            region = _d;
            (_e = formatDate(signingDate)),
              (shortDate = _e.shortDate),
              (longDate = _e.longDate);
            scope = createScope(
              shortDate,
              region,
              signingService !== null && signingService !== void 0
            ...
            return [
              4 /*yield*/,
              getPayloadHash({ headers: {}, body: payload }, this.sha256),
            ];
          case 4:
      ...
      return __generator(this, function (_f) {
        switch (_f.label) {
          ...
          case 5:
            payloadHash = _f.sent();
            if (
              !hasHeader(SHA256_HEADER, request.headers) &&
              this.applyChecksum
            ) {
  ...
  SignatureV4.prototype.createCanonicalRequest = function (
    request,
    canonicalHeaders,
    payloadHash
  ) {
  ...
  SignatureV4.prototype.getSigningKey = function (
    credentials,
    region,
    shortDate,
    service
...
var isClockSkewed = function (newServerTime, systemClockOffset) {
  return (
    Math.abs(
      getSkewCorrectedDate(systemClockOffset).getTime() - newServerTime
    ) >= 300000
  );
};
            ...
            case 4:
              return [
                ...
                _b.apply(void 0, [
                  __assign.apply(
                    void 0,
                    _c.concat([((_d.request = _e.sent()), _d)])
                  ),
                ]),
              ];
            case 5:
...
var Client = /** @class */ (function () {
  ...
  Client.prototype.send = function (command, optionsOrCb, cb) {
    ...
    var handler = command.resolveMiddleware(
  ...
  ServerSideEncryptionRule.filterSensitiveLog = (obj) => ({
    ...
    ...(obj.ApplyServerSideEncryptionByDefault && {
      ApplyServerSideEncryptionByDefault:
        ServerSideEncryptionByDefault.filterSensitiveLog(
          obj.ApplyServerSideEncryptionByDefault
        ),
    }),
  });
  ...
  GetBucketEncryptionOutput.filterSensitiveLog = (obj) => ({
    ...
    ...(obj.ServerSideEncryptionConfiguration && {
      ServerSideEncryptionConfiguration:
        ServerSideEncryptionConfiguration.filterSensitiveLog(
          obj.ServerSideEncryptionConfiguration
        ),
    }),
  });
...
const convert2nimn = function (node, e_schema, options) {
  options = buildOptions$1(
    options,
    xmlstr2xmlnode.defaultOptions,
    xmlstr2xmlnode.props
  );
...
const serializeAws_restXmlGetObjectCommand = async (input, context) => {
  const headers = {
    ...
    ...(isSerializableHeaderValue(input.IfUnmodifiedSince) && {
      "If-Unmodified-Since": dateToUtcString(
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              if (
                typeof (logger === null || logger === void 0
                  ? void 0
        ...
        return __generator(this, function (_g) {
          switch (_g.label) {
            ...
            case 1:
              ...
              (properties_1 = __values(properties)),
            ...
            case 8:
              return [
                2 /*return*/,
                next(__assign(__assign({}, args), { input: input })),
              ];
          }
        });
      });
...
const streamPipelinePromisified = promisify(
  Stream__default["default"].pipeline
);
