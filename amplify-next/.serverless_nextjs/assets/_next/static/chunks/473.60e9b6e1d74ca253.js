...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [473],
  {
    8473: function (r, i, o) {
      o.r(i),
        o.d(i, {
          amplify_button: function () {
            return t;
          },
          amplify_loading_spinner: function () {
            return e;
          },
          amplify_section: function () {
            return a;
          },
        });
      var n = o(2508),
            ...
            (r.prototype.render = function () {
              ...
              return (0, n.h)(
                ...
                (0, n.h)(
                  "button",
                  {
                    class: ((r = {}), (r[this.variant] = !0), r),
                    type: this.type,
                    disabled: this.disabled,
                    onClick: this.handleButtonClick,
                  },
                  "icon" === this.variant &&
                    (0, n.h)("amplify-icon", { name: this.icon }),
                  (0, n.h)("slot", null)
                )
              );
            }),
      ...
      var a = (function () {
        function r(r) {
          (0, n.r)(this, r), (this.role = "application");
        }
        return (
          (r.prototype.render = function () {
            return (0, n.h)(
