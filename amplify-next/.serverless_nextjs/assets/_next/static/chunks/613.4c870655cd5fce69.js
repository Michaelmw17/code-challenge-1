...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [613],
  {
    2613: function (t, e, r) {
      r.r(e),
        r.d(e, {
          amplify_radio_button: function () {
            return p;
          },
          amplify_toast: function () {
            return v;
          },
          amplify_totp_setup: function () {
            return jt;
          },
        });
      var n = r(2508),
          ...
          return (
            (t.prototype.render = function () {
              return (0, n.h)(
                ...
                (0, n.h)("amplify-label", { htmlFor: this.fieldId }, this.label)
              );
            }),
            t
          );
        ...
        return (
          (t.prototype.render = function () {
            return (0, n.h)(
              ...
              this.message ? (0, n.h)("span", null, this.message) : null,
              (0, n.h)("slot", null),
              (0, n.h)("button", {
                class: "toast-close",
      ...
      var b = E.TYPED_ARRAY_SUPPORT ? 2147483647 : 1073741823;
      function E(t, e, r) {
      ...
      function A(t, e) {
        ...
        return (
          E.TYPED_ARRAY_SUPPORT
            ? ((r = new Uint8Array(e)).__proto__ = E.prototype)
            : (null === (r = t) && (r = new E(e)), (r.length = e)),
          r
        );
      }
      function P(t, e) {
        var r = A(t, e < 0 ? 0 : 0 | T(e));
        if (!E.TYPED_ARRAY_SUPPORT) for (var n = 0; n < e; ++n) r[n] = 0;
        return r;
      }
      function C(t, e) {
        for (
          var r = e.length < 0 ? 0 : 0 | T(e.length), n = A(t, r), o = 0;
          o < r;
          o += 1
        )
          n[o] = 255 & e[o];
      ...
      E.TYPED_ARRAY_SUPPORT &&
        ...
        (E.prototype.slice = function (t, e) {
          ...
          if (
            ...
            (r = this.subarray(t, e)).__proto__ = E.prototype;
          else {
            var o = e - t;
            r = new E(o, void 0);
      ...
      function q(t) {
        ...
        (this.size = t), (this.data = B(t * t)), (this.reservedBit = B(t * t));
      }
      (q.prototype.set = function (t, e, r, n) {
        ...
        (q.prototype.xor = function (t, e, r) {
      ...
      !(function () {
        for (var t = 1, e = 0; e < 255; e++)
          (W[e] = t), (Z[t] = e), 256 & (t <<= 1) && (t ^= 285);
        for (e = 255; e < 512; e++) W[e] = W[e - 255];
      })();
      var tt = function (t) {
          return W[t];
        },
        et = function (t, e) {
          return 0 === t || 0 === e ? 0 : W[Z[t] + Z[e]];
        },
        rt = Y(function (t, e) {
          (e.mul = function (t, e) {
            for (var r = B(t.length + e.length - 1), n = 0; n < t.length; n++)
              for (var o = 0; o < e.length; o++) r[n + o] ^= et(t[n], e[o]);
            return r;
          }),
            (e.mod = function (t, e) {
              for (var r = x(t); r.length - e.length >= 0; ) {
            ...
            (e.generateECPolynomial = function (t) {
              for (var r = x([1]), n = 0; n < t; n++) r = e.mul(r, [1, tt(n)]);
              return r;
            });
        }),
        nt = l.Buffer;
      ...
      (ot.prototype.initialize = function (t) {
        (this.degree = t),
          (this.genPoly = rt.generateECPolynomial(this.degree));
      }),
        (ot.prototype.encode = function (t) {
          if (!this.genPoly) throw new Error("Encoder not initialized");
          var e = B(this.degree),
            r = nt.concat([t, e], t.length + this.degree),
            n = rt.mod(r, this.genPoly),
      ...
      var it = ot,
        ...
        ft =
          ...
          ")(?:.|[\r\n]))+",
        ct = new RegExp(st, "g"),
        ht = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g"),
        lt = new RegExp(ft, "g"),
        dt = new RegExp(ut, "g"),
        gt = new RegExp("[A-Z $%*+\\-./:]+", "g"),
        pt = new RegExp("^" + st + "$"),
        vt = new RegExp("^[0-9]+$"),
        yt = new RegExp("^[A-Z0-9 $%*+\\-./:]+$"),
        mt = {
          KANJI: ct,
          BYTE_KANJI: ht,
          BYTE: lt,
        ...
        wt = Y(function (t, e) {
          (e.NUMERIC = { id: "Numeric", bit: 1, ccBits: [10, 12, 14] }),
            ...
            (e.getCharCountIndicator = function (t, e) {
              ...
              if (!at(e)) throw new Error("Invalid version: " + e);
              return e >= 1 && e < 10
                ? t.ccBits[0]
                : e < 27
                ? t.ccBits[1]
            ...
            (e.getBestModeForData = function (t) {
              return mt.testNumeric(t)
                ? e.NUMERIC
                : mt.testAlphanumeric(t)
                ? e.ALPHANUMERIC
                : mt.testKanji(t)
                ? e.KANJI
                : e.BYTE;
        ...
        bt = Y(function (t, e) {
          var r = k(7973);
          function n(t, e) {
            return wt.getCharCountIndicator(t, e) + 4;
          }
          function o(t, e) {
            var r = 0;
            return (
          ...
          (e.from = function (t, e) {
            return at(t) ? parseInt(t, 10) : e;
          }),
            (e.getCapacity = function (t, e, r) {
              if (!at(t)) throw new Error("Invalid QR Code version");
              "undefined" === typeof r && (r = wt.BYTE);
              var o = 8 * (S(t) - G(t, e));
              if (r === wt.MIXED) return o;
              var i = o - n(r, t);
              switch (r) {
                case wt.NUMERIC:
            ...
            (e.getBestVersionForData = function (t, r) {
              ...
              if (w(t)) {
                if (t.length > 1)
                  return (function (t, r) {
                    for (var n = 1; n <= 40; n++)
                      if (o(t, n) <= e.getCapacity(n, r, wt.MIXED)) return n;
                  })(t, i);
            ...
            (e.getEncodedBits = function (t) {
              if (!at(t) || t < 7) throw new Error("Invalid QR Code version");
              for (var e = t << 12; k(e) - r >= 0; ) e ^= 7973 << (k(e) - r);
              return (t << 12) | e;
            });
        }),
        Et = k(1335),
        Tt = function (t, e) {
          for (var r = (t.bit << 3) | e, n = r << 10; k(n) - Et >= 0; )
            n ^= 1335 << (k(n) - Et);
          return 21522 ^ ((r << 10) | n);
        };
      function At(t) {
      ...
      (Rt.getBitsLength = function (t) {
        ...
        (Rt.prototype.write = function (t) {
          ...
          for (e = 0; e + 2 <= this.data.length; e += 2) {
            var r = 45 * Ct.indexOf(this.data[e]);
            (r += Ct.indexOf(this.data[e + 1])), t.put(r, 11);
          }
          this.data.length % 2 && t.put(Ct.indexOf(this.data[e]), 6);
        });
      var It = Rt;
      function _t(t) {
        (this.mode = wt.BYTE), (this.data = x(t));
      }
      (_t.getBitsLength = function (t) {
        return 8 * t;
      }),
        (_t.prototype.getLength = function () {
          return this.data.length;
        }),
        (_t.prototype.getBitsLength = function () {
          return _t.getBitsLength(this.data.length);
        }),
      ...
      var Bt = _t;
      function xt(t) {
        (this.mode = wt.KANJI), (this.data = t);
      }
      ...
      var Mt = xt,
          ...
          var e = {
            ...
            PriorityQueue: {
              make: function (t) {
                ...
                return (
                  (o.queue = []), (o.sorter = t.sorter || n.default_sorter), o
                );
              },
        ...
        St = Y(function (t, e) {
          ...
          function o(t) {
            var e,
              r,
              o = n(mt.NUMERIC, wt.NUMERIC, t),
              i = n(mt.ALPHANUMERIC, wt.ALPHANUMERIC, t);
            return (
              U()
                ? ((e = n(mt.BYTE, wt.BYTE, t)), (r = n(mt.KANJI, wt.KANJI, t)))
                : ((e = n(mt.BYTE_KANJI, wt.BYTE, t)), (r = [])),
              o
                .concat(i, e, r)
                .sort(function (t, e) {
          ...
          function i(t, e) {
            switch (e) {
              case wt.NUMERIC:
                return Pt.getBitsLength(t);
              case wt.ALPHANUMERIC:
                return It.getBitsLength(t);
              case wt.KANJI:
                return Mt.getBitsLength(t);
              case wt.BYTE:
                return Bt.getBitsLength(t);
            }
          }
          function a(t, e) {
            var r,
              n = wt.getBestModeForData(t);
            if ((r = wt.from(e, n)) !== wt.BYTE && r.bit < n.bit)
              throw new Error(
                '"' +
                  t +
            ...
            switch ((r !== wt.KANJI || U() || (r = wt.BYTE), r)) {
              case wt.NUMERIC:
                return new Pt(t);
              case wt.ALPHANUMERIC:
                return new It(t);
            ...
            (e.fromString = function (t, n) {
              for (
                var a = (function (t, e) {
                    for (
                      ...
                      for (var u = t[a], s = [], f = 0; f < u.length; f++) {
                        var c = u[f],
                          h = "" + a + f;
                        s.push(h),
                          (r[h] = { node: c, lastCount: 0 }),
                          (n[h] = {});
                        for (var l = 0; l < o.length; l++) {
                          var d = o[l];
                          r[d] && r[d].node.mode === c.mode
                            ? ((n[d][h] =
                                i(r[d].lastCount + c.length, c.mode) -
                                i(r[d].lastCount, c.mode)),
                              (r[d].lastCount += c.length))
                            : (r[d] && (r[d].lastCount = c.length),
                              (n[d][h] =
                                i(c.length, c.mode) +
                                4 +
                                wt.getCharCountIndicator(c.mode, e)));
                        }
                      }
                      o = s;
                    }
                    for (l = 0; l < o.length; l++) n[o[l]].end = 0;
                  ...
                  u = Nt.find_path(a.map, "start", "end"),
                  s = [],
                  f = 1;
                f < u.length - 1;
                f++
              )
                s.push(a.table[u[f]].node);
              return e.fromArray(
                (function (t) {
                  return t.reduce(function (t, e) {
      ...
      function Lt(t, e, r) {
        ...
        r.forEach(function (e) {
          n.put(e.mode.bit, 4),
            n.put(e.getLength(), wt.getCharCountIndicator(e.mode, t)),
            e.write(n);
        });
        var o = 8 * (S(t) - G(t, e));
        for (
        ...
        return (function (t, e, r) {
          ...
          var b,
            ...
            A = 0;
          for (b = 0; b < v; b++)
            for (E = 0; E < a; E++) b < g[E].length && (T[A++] = g[E][b]);
          for (b = 0; b < h; b++) for (E = 0; E < a; E++) T[A++] = p[E][b];
          return T;
        })(n, t, e);
      }
      function Ut(t, e, r, n) {
        var o;
        if (w(t)) o = St.fromArray(t);
        else {
          if ("string" !== typeof t) throw new Error("Invalid data");
          var i = e;
          if (!i) {
            var a = St.rawSplit(t);
            i = bt.getBestVersionForData(a, r);
          }
          o = St.fromString(t, i || 40);
        }
        var u = bt.getBestVersionForData(o, r);
        if (!u)
          throw new Error(
        ...
        return (
          (function (t, e) {
            for (var r = t.size, n = j(e), o = 0; o < n.length; o++)
          ...
          (function (t, e) {
            for (var r = J.getPositions(e), n = 0; n < r.length; n++)
          ...
          e >= 7 &&
            (function (t, e) {
              for (
                var r, n, o, i = t.size, a = bt.getEncodedBits(e), u = 0;
                u < 18;
                u++
              )
                (r = Math.floor(u / 3)),
          ...
          isNaN(n) && (n = Q.getBestMask(c, kt.bind(null, c, r))),
          Q.applyMask(n, c),
          kt(c, r, n),
          {
            modules: c,
      ...
      var Ot = function (t, e) {
          ...
          return (
            "undefined" !== typeof e &&
              ((o = F.from(e.errorCorrectionLevel, F.M)),
              (r = bt.from(e.version)),
              (n = Q.from(e.maskPattern)),
              e.toSJISFunc && L(e.toSJISFunc)),
            Ut(t, r, o, n)
          );
        },
        Yt = Y(function (t, e) {
        ...
        Ft = Y(function (t, e) {
          (e.render = function (t, e, r) {
            ...
            "undefined" !== typeof n ||
              ...
              (n = Yt.getOptions(n));
            var i = Yt.getImageWidth(t.modules.size, n),
              a = o.getContext("2d"),
              u = a.createImageData(i, i);
            return (
              Yt.qrToImageData(u.data, t, n),
              (function (t, e, r) {
              ...
              for (var n = "", o = 0, i = !1, a = 0, u = 0; u < t.length; u++) {
                ...
                s || i || (i = !0),
                  t[u]
                    ? (a++,
                      (u > 0 && s > 0 && t[u - 1]) ||
                        ((n += i ? zt("M", s + r, 0.5 + f + r) : zt("m", o, 0)),
                        (o = 0),
                        (i = !1)),
                      (s + 1 < e && t[u + 1]) || ((n += zt("h", a)), (a = 0)))
                    : o++;
              }
              return n;
            })(i, o, n.margin) +
      ...
      function Ht(t, e, r, n, o) {
        ...
        if (!u && !y()) throw new Error("Callback required as last argument");
        if (!u) {
        ...
        2 === a
          ? ((o = r), (r = e), (e = n = void 0))
          : 3 === a &&
            (e.getContext && "undefined" === typeof o
              ? ((o = n), (n = void 0))
      ...
      var Jt = {
          create: Ot,
          toCanvas: Ht.bind(null, Ft.render),
          toDataURL: Ht.bind(null, Ft.renderToDataURL),
          toString: Ht.bind(null, function (t, e, r) {
            return qt(t, r);
          }),
        },
        Kt = new o.k("TOTP"),
        jt = (function () {
          function t(t) {
            (0, n.r)(this, t),
              ...
              (this.headerText = s.T.TOTP_HEADER_TEXT),
              (this.issuer = s.T.TOTP_ISSUER),
          ...
          return (
                ...
                return g(this, function (e) {
                  switch (e.label) {
                    case 0:
                      return (
                        this.standalone ||
                          (this.removeHubListener = (0, c.o)(function (e) {
                            e === a.A.TOTPSetup && t.setup();
                          })),
                        [4, this.setup()]
                      );
                    case 1:
            ...
            (t.prototype.handleUserChange = function () {
              this.standalone && this.setup();
            }),
            (t.prototype.disconnectedCallback = function () {
              this.removeHubListener && this.removeHubListener();
            }),
            (t.prototype.buildOtpAuthPath = function (t, e, r) {
              return (
                "otpauth://totp/" +
                e +
                ":" +
            ...
            (t.prototype.onTOTPEvent = function (t) {
              return d(this, void 0, void 0, function () {
                return g(this, function (e) {
                  switch (e.label) {
                    case 0:
                      return (
                        Kt.debug("on totp event"),
                        [4, (0, h.c)(t, this.handleAuthStateChange)]
                      );
                    case 1:
                      return e.sent(), [2];
                  }
            ...
            (t.prototype.handleTotpInputChange = function (t) {
              (this.setupMessage = null), (this.qrCodeInput = t.target.value);
            }),
            (t.prototype.generateQRCode = function (t) {
              return d(this, void 0, void 0, function () {
                var e, r;
                return g(this, function (n) {
                  switch (n.label) {
                    ...
                    case 1:
                      return (e.qrCodeImageSource = n.sent()), [3, 3];
                    case 2:
                      return (r = n.sent()), (0, c.a)(r), [3, 3];
                    case 3:
                      return [2];
                  }
                });
                ...
                return g(this, function (n) {
                  switch (n.label) {
                    case 0:
                      ...
                      if (!u.g || "function" !== typeof u.g.setupTOTP)
                        throw new Error(f.N);
                      (this.setupMessage = null),
                        (t = encodeURI(i.o.get(this.issuer))),
                        (this.loading = !0),
                        (n.label = 1);
                    case 1:
                      return (
                        n.trys.push([1, 3, 4, 5]), [4, u.g.setupTOTP(this.user)]
                      );
                    case 2:
                      return (
                        (e = n.sent()),
                        Kt.debug("secret key", e),
                        (this.code = this.buildOtpAuthPath(this.user, t, e)),
                    ...
                    case 3:
                      return (
                        (r = n.sent()),
                        (0, c.a)(r),
                        Kt.debug(i.o.get(s.T.TOTP_SETUP_FAILURE), r),
                        [3, 5]
                      );
                    case 4:
            ...
            (t.prototype.verifyTotpToken = function (t) {
              return d(this, void 0, void 0, function () {
                var e, r;
                return g(this, function (n) {
                  switch (n.label) {
                    case 0:
                      if ((t && t.preventDefault(), !this.qrCodeInput))
                        return Kt.debug("No TOTP Code provided"), [2];
                      if (
                        ((e = this.user),
                        !u.g ||
                          "function" !== typeof u.g.verifyTotpToken ||
                          "function" !== typeof u.g.setPreferredMFA)
                      )
                        throw new Error(f.N);
                      n.label = 1;
                    case 1:
                      return (
                        n.trys.push([1, 5, , 6]),
                        [4, u.g.verifyTotpToken(e, this.qrCodeInput)]
                      );
                    case 2:
                      return n.sent(), [4, u.g.setPreferredMFA(e, a.M.TOTP)];
                    case 3:
                      return (
                        n.sent(),
                        (this.setupMessage = i.o.get(s.T.TOTP_SUCCESS_MESSAGE)),
                        Kt.debug(i.o.get(s.T.TOTP_SUCCESS_MESSAGE)),
                        [4, this.handleComplete(e)]
                      );
                    case 4:
                      return n.sent(), [3, 6];
                    case 5:
                      return (
                        (r = n.sent()),
                        (this.setupMessage = i.o.get(s.T.TOTP_SETUP_FAILURE)),
                        Kt.error(r),
                        [3, 6]
                      );
                    case 6:
              ...
              return (0, n.h)(
                ...
                (0, n.h)(
                  "amplify-form-section",
                  {
                    ...
                    submitButtonText: i.o.get(s.T.TOTP_SUBMIT_BUTTON_TEXT),
                    handleSubmit: function (e) {
                      return t.verifyTotpToken(e);
                    },
                  ...
                  (0, n.h)(
                    ...
                    this.qrCodeImageSource &&
                      (0, n.h)("img", {
                        ...
                        alt: i.o.get(s.T.QR_CODE_ALT),
                      }),
                    (0, n.h)("amplify-form-field", {
                      label: i.o.get(s.T.TOTP_LABEL),
                      inputProps: this.inputProps,
                      fieldId: "totpCode",
                      name: "totpCode",
                      handleInputChange: function (e) {
                        return t.handleTotpInputChange(e);
                      },
                    })
                  )
                )
            ...
            switch (s.label) {
              case 0:
                if (!a.g || "function" !== typeof a.g.verifiedContact)
                  throw new Error(f.N);
                if (!v(t)) return e(i.A.SignedIn, t), [2];
                s.label = 1;
              case 1:
                return s.trys.push([1, 3, , 4]), [4, a.g.verifiedContact(t)];
              case 2:
                return (
                  (r = s.sent()),
                  !(0, o.xb)(r.verified) || (0, o.xb)(r.unverified)
                    ? e(i.A.SignedIn, t)
                    : ((n = Object.assign(t, r)), e(i.A.VerifyContact, n)),
                  [3, 4]
                );
              case 3:
                return (u = s.sent()), (0, c.a)(u), [3, 4];
              case 4:
                return [2];
            }
          });
            ...
            return l(this, function (h) {
              switch (h.label) {
                case 0:
                  ...
                  h.label = 1;
                case 1:
                  return h.trys.push([1, 9, , 10]), [4, a.g.signIn(t, e)];
                case 2:
                  return (
                    (o = h.sent()),
                    d.debug(o),
                    o.challengeName !== i.C.SMSMFA &&
                    o.challengeName !== i.C.SoftwareTokenMFA
                      ? [3, 3]
                      : (d.debug("confirm user with " + o.challengeName),
                        r(i.A.ConfirmSignIn, o),
                        [3, 8])
                  );
                case 3:
                  return o.challengeName !== i.C.NewPasswordRequired
                    ? [3, 4]
                    : (d.debug("require new password", o.challengeParam),
                      r(i.A.ResetPassword, o),
                      [3, 8]);
                case 4:
                  return o.challengeName !== i.C.MFASetup
                    ? [3, 5]
                    : (d.debug("TOTP setup", o.challengeParam),
                      r(i.A.TOTPSetup, o),
                      [3, 8]);
                case 5:
                  return o.challengeName === i.C.CustomChallenge &&
                    o.challengeParam &&
                    "true" === o.challengeParam.trigger
                    ? (d.debug("custom challenge", o.challengeParam),
                      r(i.A.CustomConfirmSignIn, o),
                      [3, 8])
                    : [3, 6];
                case 6:
                  return [4, g(o, r)];
                ...
                case 9:
                  return (
                    "UserNotConfirmedException" === (u = h.sent()).code
                      ? (d.debug("the user is not confirmed"),
                        r(i.A.ConfirmSignUp, { username: t }))
                      : "PasswordResetRequiredException" === u.code
                      ? (d.debug("the user requires a new password"),
                        r(i.A.ForgotPassword, { username: t }))
                      : "InvalidParameterException" === u.code && "" === e
                      ? (d.debug("Password cannot be empty"),
                        (u.message = s.T.EMPTY_PASSWORD))
                      : u.message === s.T.EMPTY_USERNAME &&
                        (n === i.U.email && (u.message = s.T.EMPTY_EMAIL),
                        n === i.U.phone_number &&
                          (u.message = s.T.EMPTY_PHONE)),
                    (0, c.a)(u),
                    [3, 10]
                  );
                case 10:
