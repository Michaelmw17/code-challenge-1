  ...
  [843],
  {
    1041: function () {
      ...
      function r(t, e) {
        ...
        var p = t.rules;
        if (p)
          for (var f = 0, h = p.length, v = void 0; f < h && (v = p[f]); f++)
            r(v, e);
        return t;
      }
      var n = {
      ...
      function I(t) {
        var e = S(w(t));
        t.forEach(function (t) {
          t.usesCssVars && (t.styleEl.textContent = d(t.template, e));
        });
      }
      function R(t, e, r) {
        return (function (t, e, r) {
        ...
        U = (function () {
          ...
          return (
                  ...
                  new Promise(function (e) {
                    t.win.requestAnimationFrame(function () {
                      (function (t, e) {
                        ...
                        _(t.doc, t.globalScopes).then(function () {
                          return e();
                        });
                    });
                  }));
            ...
            (t.prototype.addLink = function (t) {
              var e = this;
              return L(this.doc, this.globalScopes, t).then(function () {
                e.updateGlobal();
              });
            }),
                ...
                s.usesCssVars
                  ? n
                    ? ((o["s-sc"] = e = s.scopeId + "-" + this.count),
                      ...
                      this.count++)
                    : ((s.styleEl = o),
                      s.usesCssVars || (o.textContent = d(s.template, {})),
      ...
      !(T = "undefined" != typeof window && window) ||
        ...
        (T.__cssshim = new U(T, T.document));
    },
  },
]);
