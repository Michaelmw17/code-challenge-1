...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [885],
  {
    885: function (t, e, n) {
      n.r(e),
        n.d(e, {
          amplify_federated_buttons: function () {
            return l;
          },
          amplify_strike: function () {
            return d;
          },
        });
      var a = n(2508),
        ...
        l = (function () {
          function t(t) {
            (0, a.r)(this, t),
              (this.authState = o.A.SignIn),
              (this.federated = {}),
              (this.handleAuthStateChange = u.d);
          }
          return (
            (t.prototype.componentWillLoad = function () {
              if (!h.g || "function" !== typeof h.g.configure)
                throw new Error(r.N);
              var t = h.g.configure().oauth,
                e = void 0 === t ? {} : t;
              e.domain
            ...
            (t.prototype.render = function () {
              if (!Object.values(o.A).includes(this.authState)) return null;
              if ((0, i.xb)(this.federated)) return null;
              var t = this.federated,
                e = t.amazonClientId,
                n = t.auth0Config,
                h = t.facebookAppId,
                r = t.googleClientId,
              ...
              return (0, a.h)(
                ...
                u &&
                  (0, a.h)(
                    "div",
                    null,
                    (0, a.h)("amplify-oauth-button", { config: u })
                  ),
                n &&
                  (0, a.h)(
                    "div",
                    null,
                    (0, a.h)("amplify-auth0-button", {
                      config: n,
                      handleAuthStateChange: this.handleAuthStateChange,
                    })
                  )
