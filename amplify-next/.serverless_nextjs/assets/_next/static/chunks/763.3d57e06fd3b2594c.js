...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [763],
  {
    3763: function (e, l, a) {
      a.r(l),
        a.d(l, {
          amplify_auth_fields: function () {
            return s;
          },
          amplify_code_field: function () {
            return d;
          },
          amplify_country_dial_code: function () {
            return h;
          },
          amplify_email_field: function () {
            return v;
          },
          amplify_form_section: function () {
            return p;
          },
          amplify_password_field: function () {
            return c;
          },
          amplify_phone_field: function () {
            return f;
          },
          amplify_select: function () {
            return g;
          },
          amplify_username_field: function () {
            return C;
          },
        });
      var t = a(2508),
        ...
        o = {
          username: function (e) {
            return (0, t.h)("amplify-username-field", {
              label: e.label,
          ...
          password: function (e) {
            return (0, t.h)("amplify-password-field", {
              label: e.label,
              placeholder: e.placeholder,
              hint: e.hint,
              required: e.required,
          ...
          email: function (e) {
            return (0, t.h)("amplify-email-field", {
              label: e.label,
              placeholder: e.placeholder,
              required: e.required,
              handleInputChange: e.handleInputChange,
          ...
          code: function (e) {
            return (0, t.h)("amplify-code-field", {
              label: e.label,
              placeholder: e.placeholder,
              hint: e.hint,
              required: e.required,
              handleInputChange: e.handleInputChange,
              value: e.value,
              inputProps: Object.assign(Object.assign({}, e.inputProps), {
                min: "0",
              }),
              disabled: e.disabled,
            });
          ...
          phone_number: function (e) {
            return (0, t.h)("amplify-phone-field", {
              label: e.label,
              placeholder: e.placeholder,
              required: e.required,
              handleInputChange: e.handleInputChange,
          ...
          default: function (e) {
            return (0, t.h)("amplify-form-field", {
              label: e.label,
              type: e.type,
              placeholder: e.placeholder,
              required: e.required,
      ...
      s.style = ".auth-fields{margin-bottom:2rem}";
      var d = (function () {
          function e(e) {
            (0, t.r)(this, e),
              (this.fieldId = r.i),
              (this.label = u.T.CODE_LABEL),
              (this.placeholder = u.T.CODE_PLACEHOLDER),
              (this.required = !1);
          }
          return (
            (e.prototype.render = function () {
              return (0, t.h)("amplify-form-field", {
                ...
                label: i.o.get(this.label),
                placeholder: i.o.get(this.placeholder),
                type: "number",
                hint: this.hint,
        ...
        h = (function () {
          ...
          return (
            ...
            (e.prototype.watchDialCodeHandler = function () {
              this.setSelectedDialCode();
            }),
            (e.prototype.setSelectedDialCode = function () {
              "number" === typeof this.dialCode
                ? (this.selectedDialCode = "+" + this.dialCode)
                : (this.selectedDialCode = this.dialCode);
            }),
            (e.prototype.render = function () {
              return (0, t.h)("amplify-select", {
                fieldId: this.fieldId,
        ...
        v = (function () {
          function e(e) {
            (0, t.r)(this, e),
              (this.fieldId = r.E),
              (this.label = u.T.EMAIL_LABEL),
              (this.placeholder = u.T.EMAIL_PLACEHOLDER),
              (this.required = !1);
          }
          return (
            (e.prototype.render = function () {
        ...
        p = (function () {
          ...
          return (
            (e.prototype.handleFormSubmit = function (e) {
                    ...
                    (0, t.h)(
                      ...
                      (0, t.h)(
                        ...
                        (0, t.h)(
                          ...
                          this.loading
                            ? (0, t.h)("amplify-loading-spinner", null)
                            : (0, t.h)("span", null, this.submitButtonText)
                        ),
      ...
      var c = (function () {
          function e(e) {
            (0, t.r)(this, e),
              (this.fieldId = r.j),
              (this.label = u.T.PASSWORD_LABEL),
              (this.placeholder = u.T.PASSWORD_PLACEHOLDER),
              (this.required = !1);
          }
          return (
            (e.prototype.render = function () {
        ...
        f = (function () {
          function e(e) {
            (0, t.r)(this, e),
              (this.fieldId = r.b),
              (this.label = u.T.PHONE_LABEL),
              (this.placeholder = u.T.PHONE_PLACEHOLDER),
              (this.required = !1);
          }
          return (
            (e.prototype.render = function () {
              return (0, t.h)(
                ...
                (0, t.h)(
                  "amplify-form-field",
                  { label: i.o.get(this.label), hint: this.hint },
                  (0, t.h)(
                    "div",
                    { class: "phone-field", slot: "input" },
                    (0, t.h)("amplify-country-dial-code", {
      ...
      var m = [{ label: "", value: 1 }],
        y = new n.k("amplify-select"),
        g = (function () {
          function e(e) {
            (0, t.r)(this, e), (this.options = m);
          }
          return (
            (e.prototype.componentWillLoad = function () {
              this.selectOptions = this.contructSelectOptions(this.options);
            }),
            (e.prototype.handleSelectOptionsChange = function () {
              this.selectOptions = this.contructSelectOptions(this.options);
            }),
            (e.prototype.isSelectedOptionValid = function (e) {
              return (
                !(
                  e &&
                  !this.options.some(function (l) {
                    return l.value === e;
                  })
                ) ||
                (y.warn(
            ...
            (e.prototype.contructSelectOptions = function (e) {
              var l = this;
              ...
              return (
                e.forEach(function (e) {
                  a.push(
                    (0, t.h)(
                      "option",
                      { value: e.value, selected: e.value === l.selected },
                      e.label
                    )
                  );
                }),
      ...
      var C = (function () {
        function e(e) {
          (0, t.r)(this, e),
            (this.fieldId = r.k),
            (this.label = u.T.USERNAME_LABEL),
            (this.placeholder = u.T.USERNAME_PLACEHOLDER),
            (this.required = !1);
        }
        return (
          (e.prototype.render = function () {
