      ...
      var r = i(2508),
        ...
        l = (function () {
          function e(e) {
            var t = this;
            (0, r.r)(this, e),
              (this.headerTitle = a.T.PHOTO_PICKER_TITLE),
              (this.headerHint = a.T.PHOTO_PICKER_HINT),
              (this.placeholderHint = a.T.PHOTO_PICKER_PLACEHOLDER_HINT),
              (this.buttonText = a.T.PHOTO_PICKER_BUTTON_TEXT),
              ...
              return (0, r.h)(
                ...
                (0, r.h)(
                  ...
                  (0, r.h)(
                    "div",
                    { class: "header" },
                    o.o.get(this.headerTitle)
                  ),
                  (0, r.h)(
                    "div",
                    { class: "header-hint" },
                    o.o.get(this.headerHint)
                  ),
                  (0, r.h)(
                    "amplify-picker",
                    ...
                    (0, r.h)(
                      ...
                      this.previewState
                        ? (0, r.h)("img", { src: "" + this.previewState })
                        : (0, r.h)("amplify-icon", { name: "photoPlaceholder" })
                    )
                  ),
                  (0, r.h)(
                    "div",
                    { class: "placeholder-hint" },
                    o.o.get(this.placeholderHint)
                  ),
                  (0, r.h)(
                    "amplify-button",
                    {
                      handleButtonClick: function () {
                        return e.handleClick(e.file);
                      },
                    },
                    o.o.get(this.buttonText)
                  )
                )
              );
            }),
