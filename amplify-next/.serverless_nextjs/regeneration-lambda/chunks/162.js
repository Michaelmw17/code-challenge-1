...
exports.modules = {
  ...
  /***/ 79080: /***/ (
    ...
    var is_buffer = __webpack_require__(48738); // CONCATENATED MODULE: ./node_modules/unist-util-stringify-position/index.js
    ...
    var external_process_ = __webpack_require__(77282); // CONCATENATED MODULE: ./node_modules/vfile/lib/minproc.js
    const proc = external_process_; // CONCATENATED MODULE: ./node_modules/vfile/lib/minurl.shared.js
    ...
    var external_url_ = __webpack_require__(57310); // CONCATENATED MODULE: ./node_modules/vfile/lib/index.js
    /**
     * @typedef {import('unist').Node} Node
     * @typedef {import('unist').Position} Position
     * @typedef {import('unist').Point} Point
    ...
    var extend = __webpack_require__(94470); // CONCATENATED MODULE: ./node_modules/is-plain-obj/index.js
      ...
      return (
        (node &&
          ...
          (node.value ||
            ...
            ("children" in node &&
              mdast_util_to_string_all(node.children, includeImageAlt)) ||
            (Array.isArray(node) &&
              mdast_util_to_string_all(node, includeImageAlt)))) ||
        ""
      );
    }
    ...
    const characterEntities = {
      ...
      zwj: "‍",
      zwnj: "‌",
    }; // CONCATENATED MODULE: ./node_modules/parse-entities/lib/decode-entity.js

    const decode_entity_own = {}.hasOwnProperty;
    ...
    function decodeEntity(value) {
      ...
      return decode_entity_own.call(characterEntities, value)
    ...
    function compiler(options = {}) {
      ...
      function compile(events) {
        ...
        while (++index < events.length) {
          ...
          if (
            mdast_util_from_markdown_lib_own.call(
              handler,
              events[index][1].type
            )
          ) {
    ...
    function extension(combined, extension) {
      ...
      for (key in extension) {
        if (mdast_util_from_markdown_lib_own.call(extension, key)) {
          ...
          const maybe = mdast_util_from_markdown_lib_own.call(combined, key)
            ? combined[key]
            : undefined;
          /* c8 ignore next */
    ...
    /* harmony default export */ const remark_parse = remarkParse; // CONCATENATED MODULE: ./node_modules/unist-builder/index.js
          ...
          function factory(node, index, parents) {
            ...
            function visit() {
              ...
              if (
                ...
                result = unist_util_visit_parents_toResult(
              ...
              if (
                node.children &&
                result[0] !== unist_util_visit_parents_SKIP
              ) {
                // @ts-ignore looks like a parent.
                offset = (reverse ? node.children.length : -1) + step;
                // @ts-ignore looks like a parent.
    ...
    function definitions(node) {
      ...
      function getDefinition(identifier) {
        ...
        return id && mdast_util_definitions_own.call(cache, id)
          ? cache[id]
          : null;
      }
    }
    ...
    function returnNode(h, node) {
      ...
      return "children" in node
        ? { ...node, children: traverse_all(h, node) }
        : node;
    }
    ...
    function footer(h) {
      ...
      while (++index < footnoteOrder.length) {
        ...
        const backReference = {
          ...
          url: "#fnref" + marker,
          data: {
            hProperties: { className: ["footnote-back"], role: "doc-backlink" },
          },
    ...
    var encode = __webpack_require__(70729); // CONCATENATED MODULE: ./node_modules/mdast-util-to-hast/lib/revert.js
    /**
     * @typedef {import('mdast').LinkReference} LinkReference
     * @typedef {import('mdast').ImageReference} ImageReference
     * @typedef {import('./index.js').Handler} Handler
    ...
    var prop_types = __webpack_require__(45697); // CONCATENATED MODULE: ./node_modules/property-information/lib/util/schema.js
    /**
    ...
    /** @type {string|null} */
    Schema.prototype.space = null; // CONCATENATED MODULE: ./node_modules/property-information/lib/util/merge.js
    /**
    ...
    Info.prototype.defined = false; // CONCATENATED MODULE: ./node_modules/property-information/lib/util/types.js
    let powers = 0;
        ...
        if (typeof mask === "number") {
          while (++index < checks.length) {
            ...
            mark(
              this,
              checks[index],
              (mask & types_namespaceObject[check]) ===
                types_namespaceObject[check]
            );
          }
        }
      }
    ...
    const property_information_html = merge(
      [xml, xlink, xmlns, aria, html_html],
      "html"
    );
    ...
    var react_is = __webpack_require__(59864); // CONCATENATED MODULE: ./node_modules/hast-util-whitespace/index.js
    /**
     * @param {unknown} thing
     * @returns {boolean}
     */
    ...
    var style_to_object = __webpack_require__(57848); // CONCATENATED MODULE: ./node_modules/react-markdown/lib/ast-to-react.js
    /**
     * @template T
    ...
    function toReact(context, node, index, parent) {
      ...
      const component =
        options.components && ast_to_react_own.call(options.components, name)
          ...
          : name;
      const basic =
        typeof component === "string" || component === react.Fragment;
    ...
    function addProperty(props, prop, value, ctx) {
      ...
      if (Array.isArray(result)) {
        result = info.commaSeparated
          ? comma_separated_tokens_stringify(result)
          : stringify(result);
      }
    ...
    function ReactMarkdown(options) {
      for (const key in deprecated) {
        if (
          react_markdown_own.call(deprecated, key) &&
          react_markdown_own.call(options, key)
        ) {
      ...
      let result = react.createElement(
        ...
        {},
        childrenToReact(
          { options, schema: property_information_html, listDepth: 0 },
          hastNode
        )
      );
    ...
    ReactMarkdown.propTypes = {
      ...
      remarkPlugins: prop_types.arrayOf(
        prop_types.oneOfType([
          ...
          prop_types.func,
          prop_types.arrayOf(
            prop_types.oneOfType([prop_types.object, prop_types.func])
          ),
        ])
      ),
