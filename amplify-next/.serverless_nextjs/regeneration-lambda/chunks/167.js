...
exports.modules = {
  /***/ 82354: /***/ (
    ...
    // Requires
    var Typo = __webpack_require__(84581);
  ...
  /***/ 24442: /***/ (
    ...
    var CodeMirror = __webpack_require__(4631);
    __webpack_require__(23350);
    __webpack_require__(96912);
    __webpack_require__(960);
    __webpack_require__(49047);
    __webpack_require__(14146);
    __webpack_require__(88386);
    __webpack_require__(21994);
    __webpack_require__(64020);
    __webpack_require__(32095);
    __webpack_require__(42425);
    __webpack_require__(29589);
    var CodeMirrorSpellChecker = __webpack_require__(82354);
    ...
    EasyMDE.prototype.updateStatusBar = function (itemName, content) {
      ...
      if (matchingClasses.length === 1) {
        ...
        console.log(
          "EasyMDE: Several status bar items named " + itemName + " was found."
        );
      }
    };
    ...
    var SimpleMDEEditor = /*#__PURE__*/ (function (_React$PureComponent) {
      ...
      function SimpleMDEEditor(props) {
        ...
        _this.imageUploadFunction = function (file, onSuccess, onError) {
          ...
          var imageUpload =
            (_this$props$options = _this.props.options) === null ||
            _this$props$options === void 0
              ? void 0
              : _this$props$options.imageUploadFunction;
        ...
        _this.createEditor = function () {
          ...
          var SimpleMDE = __webpack_require__(24442);

          var initialOptions = {
            element: document.getElementById(_this.id),
            initialValue: _this.props.value,
          };
          var imageUploadFunction = (
            (_this$props$options2 = _this.props.options) === null ||
            _this$props$options2 === void 0
              ? void 0
              : _this$props$options2.imageUploadFunction
          )
            ? _this.imageUploadFunction
            : undefined;
        ...
        _this.removeEvents = function () {
          if (_this.editorEl && _this.editorToolbarEl) {
            ...
            _this.editorToolbarEl.removeEventListener(
              "click",
              _this.eventWrapper
            );
          }
        ...
        _this.addEvents = function () {
          if (_this.elementWrapperRef && _this.simpleMde) {
            ...
            _this.editorToolbarEl =
              _this.elementWrapperRef.getElementsByClassName(
                "editor-toolbar"
              )[0];
            ...
            _this.editorToolbarEl &&
              _this.editorToolbarEl.addEventListener(
                "click",
                _this.eventWrapper
              );
        ...
        _this.getCursor = function () {
          ...
          if (_this.props.getLineAndCursor) {
            _this.props.getLineAndCursor(
              _this.simpleMde.codemirror.getDoc().getCursor()
            );
          }
        };
        ...
        _this.addExtraKeys = function () {
          ...
          if (_this.props.extraKeys) {
            _this.simpleMde.codemirror.setOption(
              "extraKeys",
              Object.assign(
                {},
                _this.props.extraKeys,
                _this.simpleMde.codemirror.getOption("extraKeys")
              )
            );
          }
        };
            ...
            if (parts.length > 1) {
              ...
              for (var j = 0, _jlen = ruleCodesArray.length; j < _jlen; j++) {
                ...
                if (rule) {
                  ...
                  for (
                    var ii = 0, _iilen = newWords.length;
                    ii < _iilen;
                    ii++
                  ) {
              ...
              if ("continuationClasses" in entry) {
                for (
                  ...
                  var continuationRule =
                    this.rules[entry.continuationClasses[j]];
            ...
            for (
              ...
              if ("uppercase" === capitalization_scheme) {
                sorted_corrections[i][0] =
                  sorted_corrections[i][0].toUpperCase();
