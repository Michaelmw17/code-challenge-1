            ...
            >
              <div className={classes.front}>
                <div className={classes.frontContent}>
                  ...
                  <div
                    key={index}
                    className="border-b border-gray-300	mt-8 pb-4 text-center"
                  >
                    <p className="text-xl font-semibold  mt-2">
                      Category: {post.category}
                    </p>
                    <p className="text-1xl mt-4 font-semibold tracking-wide mt-6 mb-6">
              ...
              <div className={classes.back}>
                <div className={classes.backContent}>
                  <h2 className="text-xl font-semibold  mt-2 text-center text-center">
                    Title: {post.title}
                  </h2>
                  <p className="text-1xl mt-4 font-semibold tracking-wide text-center">
                    Selected Category Name: {post.select}
                  </p>
                  <p className="text-1xl mt-4 font-semibold tracking-wide text-center">
                    Category: {post.category}
                  ...
                  <div className="fixed bottom-0 w-ful text-center mb-2 ml-4">
                    ...
                    <time dateTime={post.createdAt} className="invisible">
                      Blog gerenated date created at: <br />
