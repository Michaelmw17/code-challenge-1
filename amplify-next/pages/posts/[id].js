...
export default function Post({ post }) {
  ...
  return (
    <div>
      <h1 className="text-5xl mt-4 font-semibold tracking-wide mt-36 text-center">
        Title: {post.title}
      </h1>
      <h4 className="text-3xl mt-4 font-semibold tracking-wide text-center">
      ...
      <p className="text-1xl mt-4 font-semibold tracking-wide">
